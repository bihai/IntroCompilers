...
public class OffsetCalculator extends AstVisitor<Object>
{
                              ...
                              List<Object> statementResults)
    {
        ...
        // Mike: save current offset as the size of all locals
        funcDecl.getFunctionSymbol().setLocalsSize(currentOffset);
        
        // add 4 for the saved return value
        currentOffset += 4;

        // Now start computing offsets of formals
        List<FormalArg> formals = new ArrayList<FormalArg>(funcDecl.getFormalArguments());
